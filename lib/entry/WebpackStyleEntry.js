  ...
  _createClass(WebpackStyleEntry, [{
    ...
    value: function render() {
      ...
      if (outputFilepathList) {
        ...
        var _outputFilepathList$filter = outputFilepathList.filter((_context = /\.css$/).test.bind(_context));
        ...
        return _react2["default"].createElement("link", _extends({}, restProps, { href: outputFilepath }));
      } else {
